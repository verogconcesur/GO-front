...
class CustomDialogHeaderComponent {
    ...
    getTitleLabel() {
        var _a;
        return ((_a = this.config) === null || _a === void 0 ? void 0 : _a.titleLabel) ? this.config.titleLabel : '';
    }
}
...
let CustomDialogComponent = class CustomDialogComponent {
    ...
    ngOnInit() {
        this.customDialogService.closeResult$
            ...
            .subscribe((data) => {
            var _a;
            if (data.id === ((_a = this.componentRef) === null || _a === void 0 ? void 0 : _a.instance.MODAL_ID)) {
    ...
    closeAction() {
        var _a;
        if ((_a = this.componentRef) === null || _a === void 0 ? void 0 : _a.instance.confirmCloseCustomDialog) {
    ...
    submitAction() {
        var _a;
        if ((_a = this.componentRef) === null || _a === void 0 ? void 0 : _a.instance.onSubmitCustomDialog) {
            this.componentRef.instance
    ...
    changeTitle() {
        var _a;
        this.headerConfig.titleLabel = (_a = this.componentRef) === null || _a === void 0 ? void 0 : _a.instance.MODAL_TITLE;
    }
    loadInnerModalComponent() {
        var _a, _b;
        this.componentRef = (_a = this.dynamicViewContainer) === null || _a === void 0 ? void 0 : _a.createComponent(this.config.component);
        (_b = this.componentRef) === null || _b === void 0 ? void 0 : _b.instance.setModalModeActive(true);
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CustomDialogComponent, decorators: [{
        ...
        return [{ type: i1$2.MatDialogRef }, { type: CustomDialogService }, { type: undefined, decorators: [{
                        type: Inject,
...
class CustomDialogService {
    ...
    close(id, result) {
        ...
        if (result) {
            ...
            (_a = this.dialog.getDialogById(id)) === null || _a === void 0 ? void 0 : _a.close();
        }
    }
}
