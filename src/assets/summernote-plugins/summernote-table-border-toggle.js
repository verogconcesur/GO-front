        ...
        'tableBorderToggle': function (context) {
            ...
            this.toggleBorderStyle = function () {
              ...
              if (rng.isCollapsed() && rng.isOnCell()) {
                ...
                var $table = $(table);
                if($table.hasClass('table-no-bordered')){
                  $table.removeClass('table-no-bordered');  
                }else{
