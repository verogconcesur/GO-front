...
export default interface FacilityDTO {
  ...
  configApiExtDmsType?: string;
  code?: string;
  configStockCode?: string;
  enterpriseId?: string;
  configApiExtType?: string;
  configApiExtCsvHost?: string;
  configApiExtCsvPort?: number;
  configApiExtCsvDirectory?: string;
  configApiExtCsvPrefixFile?: string;
  configApiExtCsvUser?: string;
  configApiExtCsvPass?: string;
  configStockType?: string;
  configStockCsvHost?: string;
  configStockCsvPort?: number;
  configStockCsvDirectory?: string;
  configStockCsvPrefixFile?: string;
  configStockCsvUser?: string;
  configStockCsvPass?: string;
