...
export class CreateEditFacilityComponent extends ComponentToExtendForCustomDialog implements OnInit, OnDestroy {
  ...
  public labels = {
    ...
    pepperUrlOk: marker('organizations.facilities.pepperUrlOk'),
    pepperUrlKo: marker('organizations.facilities.pepperUrlKo'),
  ...
  public onSubmitCustomDialog(): Observable<boolean | FacilityDTO> {
    ...
    return this.facilityService
      .addFacility({
        ...
        locale: formValue.locale ? formValue.locale : null,
        ...
        pepperUrlOk: formValue.pepperUrlOk,
        pepperUrlKo: formValue.pepperUrlKo,
    ...
    this.facilityForm = this.fb.group(
      {
        ...
        locale: [this.facilityToEdit ? this.facilityToEdit.locale : this.locateList[0].value],
        ...
        pepperUrlOk: [this.facilityToEdit && this.facilityToEdit.pepperUrlOk ? this.facilityToEdit.pepperUrlOk : null],
        pepperUrlKo: [this.facilityToEdit && this.facilityToEdit.pepperUrlKo ? this.facilityToEdit.pepperUrlKo : null],
        configMailerHost: [
