...
export const enum CreateEditLineComponentModalEnum {
  ID = 'create-edit-line-dialog-id',
  PANEL_CLASS = 'create-edit-line-dialog',
...
export class CreateEditLineComponent extends ComponentToExtendForCustomDialog implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    super(
      CreateEditLineComponentModalEnum.ID,
      CreateEditLineComponentModalEnum.PANEL_CLASS,
      CreateEditLineComponentModalEnum.TITLE
    );
  }
